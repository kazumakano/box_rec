...
def predict(box_info_file: str, gpu_id: int, model_file: str, pj_file: str, result_dir: str, vid_file: str) -> None:
...
if __name__ == "__main__":
    ...
    predict(args.box_info_file, args.gpu_id, args.model_file, args.pj_file, args.result_dir, args.vid_file)
